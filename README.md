...
[新文字文件.txt](https://github.com/user-attachments/files/20009597/default.txt)
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "B2C_DAT" ;
  CREATE UNIQUE INDEX "DBUSERNEB"."COMPANY_PK" ON "DBUSERNEB"."COMPANY" ("COMPANY_KEY") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS NOLOGGING 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "B2C_IDX" ;
ALTER TABLE "DBUSERNEB"."COMPANY" ADD CONSTRAINT "COMPANY_PK" PRIMARY KEY ("COMPANY_KEY")
  USING INDEX "DBUSERNEB"."COMPANY_PK"  ENABLE;
...
1：不能勾選申辦業務子系統';
  ...
  CREATE INDEX "DBUSERNEB"."COMPANY" ON "DBUSERNEB"."COMPANY" ("COMPANY_UID") 
  ...
  CREATE INDEX "DBUSERNEB"."COMPANY_IDX_01" ON "DBUSERNEB"."COMPANY" ("COMPANY_UID", "STATUS", "COMPANY_KIND") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS NOLOGGING 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  ...
  CREATE INDEX "DBUSERNEB"."COMPANY_IDX_02" ON "DBUSERNEB"."COMPANY" ("COMPANY_UID", "UID_DUP") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS NOLOGGING 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  ...
  GRANT SELECT ON "DBUSERNEB"."COMPANY" TO "DBUSERDEV";
  GRANT SELECT ON "DBUSERNEB"."COMPANY" TO "DBUSER";
 ...
 NOCOMPRESS LOGGING
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "EB_LOGIN_LOG_DAT" ;
  CREATE UNIQUE INDEX "DBUSERNEB"."EB_LOGIN_LOG_B_PK" ON "DBUSERNEB"."EB_LOGIN_LOG_B" ("LOGIN_LOG_KEY") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "EB_LOGIN_LOG_DAT" ;
ALTER TABLE "DBUSERNEB"."EB_LOGIN_LOG_B" ADD CONSTRAINT "EB_LOGIN_LOG_B_PK" PRIMARY KEY ("LOGIN_LOG_KEY")
  USING INDEX "DBUSERNEB"."EB_LOGIN_LOG_B_PK"  ENABLE;
  ...
  CREATE INDEX "DBUSERNEB"."EB_LOGIN_LOG_B_IDX_01" ON "DBUSERNEB"."EB_LOGIN_LOG_B" ("SESSION_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  ...
  CREATE INDEX "DBUSERNEB"."EB_LOGIN_LOG_B_IDX_02" ON "DBUSERNEB"."EB_LOGIN_LOG_B" ("SIGNON_TOKEN") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  ...
  CREATE INDEX "DBUSERNEB"."EB_LOGIN_LOG_B_IDX_03" ON "DBUSERNEB"."EB_LOGIN_LOG_B" ("USER_KEY") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  ...
  CREATE INDEX "DBUSERNEB"."EB_LOGIN_LOG_B_IDX_04" ON "DBUSERNEB"."EB_LOGIN_LOG_B" ("LOGIN_TIME") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  ...
  CREATE INDEX "DBUSERNEB"."EB_LOGIN_LOG_B_IDX_5" ON "DBUSERNEB"."EB_LOGIN_LOG_B" ("COMPANY_KEY") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  ...
  GRANT SELECT ON "DBUSERNEB"."EB_LOGIN_LOG_B" TO "DBUSERDEV";
  GRANT SELECT ON "DBUSERNEB"."EB_LOGIN_LOG_B" TO "DBUSER";
